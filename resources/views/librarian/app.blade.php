...
<div class="container">
    <header class="d-flex flex-wrap align-items-center py-3 mb-4 border-bottom">
        ...
        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
            <li><a href="{{route('kitap_islemleri')}}" class="nav-link px-2 link-secondary">Kitap İşlemleri</a></li>
            <li><a href="{{route('uye_islemleri')}}" class="nav-link px-2">Üye İşlemleri</a></li>
            <li><a href="{{route('emanet_kitap_islemleri')}}" class="nav-link px-2">Emanet Kitap İşlemleri</a></li>
        </ul>
